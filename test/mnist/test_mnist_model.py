import unittest
import torch
from spred.mnist.model import inv_abstain_prob, max_nonabstain_prob
from spred.mnist.examples import build_interface_a_net, run_interface_a_input
from spred.mnist.examples import build_interface_b_net, run_interface_b_input
